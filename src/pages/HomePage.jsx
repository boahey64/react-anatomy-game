    ...
    return (
        <main>
            <section className="quiz-grid">
                <img src={'./thumbnails/MuskelnThumbnail.png'} alt='Muskeln' width='400px' height='800px'
                     onClick={() => console.log('click muscles')}/>
                <img src={'./thumbnails/FemurThumbnail.png'} alt='Muskeln' width='400px' height='800px'
